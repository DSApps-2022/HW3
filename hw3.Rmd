---
title: "DSApps 2022 @ TAU: Assignment 3"
...
This assignment is due: 24/3 23:59
...
* You may use any `ggplot2` extension. There are countless, some may be found [here](https://exts.ggplot2.tidyverse.org/gallery/)
...
f2 <- function(x, y) {
  ...
  y_train <- x[sample_train]
  y_test <- x[-sample_train]
